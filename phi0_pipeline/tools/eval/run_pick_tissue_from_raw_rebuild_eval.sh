...
"${PHI0_PY}" "${PHI0_ROOT}/tools/data/isaac_groot_to_xperience_unified_lerobot.py" \
...
"${PHI0_PY}" "${PHI0_ROOT}/tools/data/verify_pick_tissue_qpos_labels.py" --dst-ep 524 \
...
bash "${PHI0_ROOT}/tools/eval/run_pick_tissue_hgpt_zmq_eval.sh" \
