...
GR00T_ROOT="$(cd "${GR00T_ROOT:-${PHI0_SUBPACKAGES:-${PHI0_ROOT}/subpackages}}" && pwd)"
VENV_SIM="${VENV_SIM:-${PHI0_ROOT}/.venv_sim}"
CLUSTER_VENV="${CLUSTER_VENV_SIM:-/mnt/data2/wpy/workspace/GR00T-WholeBodyControl/.venv_sim}"
