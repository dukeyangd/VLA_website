#!/usr/bin/env bash
# 810demo_v2_egypt_layout VLA: no hist vision, H=1, offset_vlm_age, 50k steps.
set -euo pipefail
...
export CONFIG=train_810demo_egypt_vlm_h1_offset_vlm_age
...
export PHI0_DISTILL_OUT="/mnt/data3/wpy/vla_810demo_v2_h1_offset_b${BATCH_SIZE}_ddp${NGPU}_s${MAX_STEPS}_${STAMP}"
export LOG_FILE="/mnt/data2/wpy/workspace/logs/vla_810demo_v2_h1_offset_b${BATCH_SIZE}_ddp${NGPU}_s${MAX_STEPS}_${STAMP}.log"

echo "================================================================"
echo "[vla_h1_offset] 810demo_v2 VLA: current-frame dual VLM + H=1 + offset_vlm_age"
echo "================================================================"
echo "CONFIG=${CONFIG}"
...
echo "vlm_refresh: align_vlm_refresh=true period=10 (5Hz VLM @ 50Hz ctrl)"
echo "vlm_video_delta_indices=(none, current frame only)"
echo "action_future_horizon=H=1  seq_len=2  past_w=1"
echo "dual_view=ego+chest_forward (current)"
