...
CHECKPOINT="${CHECKPOINT:-${PHI0_ROOT}/experiments/pick_tissue_valid_wholebody_rtc_b256_30k_deploy_align/pick_tissue_valid_wholebody_rtc_b256_act_latest.pt}"
...
echo "[phi0_sonic_closed_loop] proprio_source=${PROPRIO_SOURCE} (robot|hybrid|roll-forward|bootstrap-roll-forward)"
...
exec "${PHI0_PY}" "${PHI0_ROOT}/tools/deploy/phi0_sonic_closed_loop_zmq.py" \
